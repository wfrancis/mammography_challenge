...
# Grid-search tuned thresholds (+0.01867 OOF lift vs 0.15/0.20/0.25/0.35)
preds[(ensemble_proba[:, 6] > 0.10)] = 6
preds[(ensemble_proba[:, 5] > 0.15) & (preds != 6)] = 5
preds[(ensemble_proba[:, 4] > 0.23) & (preds != 6) & (preds != 5)] = 4
preds[(ensemble_proba[:, 3] > 0.38) & (preds != 6) & (preds != 5) & (preds != 4)] = 3
